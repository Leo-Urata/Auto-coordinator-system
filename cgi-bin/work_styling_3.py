  ...
  <body>
    ...
    <div class="container bg-light">
        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              <td><img src="../styling_outer_img/out3.jpg" class="img-fluid"></td>
              <td><img src="../styling_tops_img/top3.jpg" class="img-fluid"></td>
              <td><img src="../styling_buttoms_img/but3.jpg" class="img-fluid"></td>
            </tr>
          </tbody>
        </table>
        
        <form action="work_styling_3.py" method="post" enctype="multipart/form-data">
...
#    cgi用パス
    filepath_outer='./styling_outer_img/out3.jpg'
    filepath_tops='./styling_tops_img/top3.jpg'
    filepath_buttoms='./styling_buttoms_img/but3.jpg'

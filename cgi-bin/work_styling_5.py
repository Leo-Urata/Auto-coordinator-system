        ...
        <table class="table">
          ...
          <tbody>
            <tr>
              ...
              <td><img src="../styling_tops_img/top5.jpg" class="img-fluid"></td>
              <td><img src="../styling_buttoms_img/but5.jpg" class="img-fluid"></td>
            </tr>
          </tbody>
        </table>
        
        <form action="work_styling_5.py" method="post" enctype="multipart/form-data">
...
#    cgi用パス
    ...
    filepath_tops='./styling_tops_img/top5.jpg'
    filepath_buttoms='./styling_buttoms_img/but5.jpg'
